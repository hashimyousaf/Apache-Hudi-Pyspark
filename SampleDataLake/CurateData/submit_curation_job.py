...
def submit_hudi_job(description):
    job_args =  ['spark-submit','--jars',
                 ...
                 '/home/hadoop/curation_data_script.py', 'true', '27-04-2020 10:39:54']
    response  = add_emr_step("j-TNMST10OZPNN", description, "CONTINUE", job_args)
    print(response)


if __name__ == '__main__':
    submit_hudi_job("Curation Job on EMR")